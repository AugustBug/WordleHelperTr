...
namespace WordleHelperTr
{
    public class WordleHelper
    {
        ...
        private const string RAW_WORDS_FILE_DIR = "../../turkce_kelime_listesi.txt";
        private const string OP_WORDS_FILE_DIR = "all5LenWords.txt";

        private Dictionary<char, char> mapUpperCase = new Dictionary<char, char>();
        ...
        public void init(MainWindow ui)
        {
            ...
            mapUpperCase.Add('a', 'A');
            mapUpperCase.Add('â', 'A');
            mapUpperCase.Add('b', 'B');
            mapUpperCase.Add('c', 'C');
            mapUpperCase.Add('ç', 'Ç');
            mapUpperCase.Add('d', 'D');
            mapUpperCase.Add('e', 'E');
            mapUpperCase.Add('f', 'F');
            mapUpperCase.Add('g', 'G');
            mapUpperCase.Add('ğ', 'Ğ');
            mapUpperCase.Add('h', 'H');
            mapUpperCase.Add('ı', 'I');
            mapUpperCase.Add('i', 'İ');
            mapUpperCase.Add('î', 'İ');
            mapUpperCase.Add('j', 'J');
            mapUpperCase.Add('k', 'K');
            mapUpperCase.Add('l', 'L');
            mapUpperCase.Add('m', 'M');
            mapUpperCase.Add('n', 'N');
            mapUpperCase.Add('o', 'O');
            mapUpperCase.Add('ö', 'Ö');
            mapUpperCase.Add('p', 'P');
            mapUpperCase.Add('r', 'R');
            mapUpperCase.Add('s', 'S');
            mapUpperCase.Add('ş', 'Ş');
            mapUpperCase.Add('t', 'T');
            mapUpperCase.Add('u', 'U');
            mapUpperCase.Add('û', 'U');
            mapUpperCase.Add('ü', 'Ü');
            mapUpperCase.Add('v', 'V');
            mapUpperCase.Add('y', 'Y');
            mapUpperCase.Add('z', 'Z');
        ...
        private string toUppercase(string word)
        {
            ...
            {
                if (mapUpperCase.ContainsKey(c))
                {
                    lowercase += mapUpperCase[c];
                }
                else
                {
                    lowercase += c;
        ...
        public char getValidChar(char c)
        {
            ...
            else if (mapUpperCase.ContainsKey(c))
            {
                return mapUpperCase[c];
            }
            return '\0';
        }
